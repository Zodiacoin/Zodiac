...
unsigned int nTargetSpacing = 60; // 1 minutes
unsigned int nStakeTargetSpacing = 60; // 1 minutes stakes spacing
...
static const int64_t nTargetTimespan = 60 * 10; // 10 mins
...
const string strMessageMagic = "Zodiaccoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Zodiaccoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Blockchain.info Block #315537 2014-08-14 07:51:20";
        CTransaction txNew;
        txNew.nTime = 1408002680;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408002680;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1574012;
        ...
        //// debug print
	block.print();
        assert(block.hashMerkleRoot == uint256("0x5322021d38dc924652000b5247d56f238ca5fb9d8d26074d9d9655013849c377"));   
