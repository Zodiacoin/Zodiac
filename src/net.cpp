...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("zodiaccoin-ext-ip");
...
void ThreadTorNet(void* parg)
{
    ...
    RenameThread("zodiaccoin-tornet");
...
void ThreadOnionSeed(void* parg)
{
    ...
    RenameThread("zodiaccoin-onionseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("zodiaccoin-adrdump");
...
{
    // Make this thread recognisable as the connection opening thread
    RenameThread("zodiaccoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("zodiaccoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zodiac is probably already running."), addrBind.ToString().c_str());
        else
